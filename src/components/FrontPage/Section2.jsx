    ...
    <>
      <div className="sec2 max-w-full md:px-6 px-4 flex flex-col items-center md:py-[100px] py-[60px] justify-center">
        <div className="mx-auto text-center md:max-w-[810px] mb-8">
          ...
          <p className="md:text-xl text-[1rem] leading-relaxed text-[#95ADB1]">
        ...
        <div className="cards max-w-full md:max-w-[1400px] md:px-6 py-16 flex justify-center items-start gap-x-4 gap-y-14 flex-wrap">
